...
const CandidateLayoutContent = ({ children }: CandidateLayoutProps) => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/candidate/dashboard', icon: Home, current: location.pathname === '/candidate/dashboard' },
    { name: 'My Interviews', href: '/candidate/interviews', icon: Calendar, current: location.pathname.includes('/candidate/interviews') },
    { name: 'My Profile', href: '/candidate/profile', icon: User, current: location.pathname.includes('/candidate/profile') },
    { name: 'Feedback', href: '/candidate/feedback', icon: MessageSquare, current: location.pathname.includes('/candidate/feedback') },
    { name: 'Settings', href: '/candidate/settings', icon: Settings, current: location.pathname.includes('/candidate/settings') },
  ];
        ...
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto border-r border-border bg-card">
          <div className="flex items-center flex-shrink-0 px-4">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">Candidate Portal</span>
            </Link>
          </div>
          ...
          <div className="flex-shrink-0 flex border-t border-border p-4">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem>
                  <Link to="/candidate/profile" className="flex w-full">
                    <User className="mr-2 h-4 w-4" />
                    Profile
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <Link to="/candidate/settings" className="flex w-full">
