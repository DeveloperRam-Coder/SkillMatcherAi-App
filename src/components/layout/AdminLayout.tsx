...
const AdminLayoutContent = ({ children }: AdminLayoutProps) => {
  ...
  const navigation = [
    ...
    { name: 'Interviews', href: '/admin/interviews', icon: Calendar, current: location.pathname.includes('/admin/interviews') },
    { name: 'Candidates', href: '/admin/candidates', icon: Users, current: location.pathname.includes('/admin/candidates') },
    { name: 'Feedback', href: '/admin/feedback', icon: MessageSquare, current: location.pathname.includes('/admin/feedback') },
    { name: 'Offers', href: '/admin/offers', icon: BriefcaseBusiness, current: location.pathname.includes('/admin/offers') },
    { name: 'Reports', href: '/admin/reports', icon: BarChart2, current: location.pathname.includes('/admin/reports') },
          ...
          <div className="flex-shrink-0 flex border-t border-border p-4">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem>
                  <Link to="/admin/reports" className="flex w-full">
